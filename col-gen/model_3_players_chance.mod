...
s.t. c21_phase1{q1 in Q1}: #add support
     sum{(p1,p2,p3) in P1P2P3} sigma[p1,p2,p3]*sum{q2 in Q2: rp2[p2,q2]==1, q3 in Q3: rp3[p3,q3]==1} U1[q1,q2,q3] + slack_c21[q1] - sum{h1 in H1} F1[h1,q1]*v1[h1] = 0;

s.t. c22_phase1{q2 in Q2}: #add support
     sum{(p1,p2,p3) in P1P2P3} sigma[p1,p2,p3]*sum{q1 in Q1: rp1[p1,q1]==1, q3 in Q3: rp3[p3,q3]==1} U2[q1,q2,q3] + slack_c22[q2] - sum{h2 in H2} F2[h2,q2]*v2[h2] = 0;

s.t. c23_phase1{q3 in Q3}: #add support
     sum{(p1,p2,p3) in P1P2P3} sigma[p1,p2,p3]*sum{q1 in Q1: rp1[p1,q1]==1, q2 in Q2: rp2[p2,q2]==1} U3[q1,q2,q3] + slack_c23[q3] - sum{h3 in H3} F3[h3,q3]*v3[h3] = 0;
...
s.t. c21{q1 in Q1}:
     sum{(p1,p2,p3) in P1P2P3} sigma[p1,p2,p3]*sum{q2 in Q2: rp2[p2,q2]==1, q3 in Q3: rp3[p3,q3]==1} U1[q1,q2,q3] - sum{h1 in H1} F1[h1,q1]*v1[h1] <= 0;

s.t. c22{q2 in Q2}:
     sum{(p1,p2,p3) in P1P2P3} sigma[p1,p2,p3]*sum{q1 in Q1: rp1[p1,q1]==1, q3 in Q3: rp3[p3,q3]==1} U2[q1,q2,q3] - sum{h2 in H2} F2[h2,q2]*v2[h2] <= 0;

s.t. c23{q3 in Q3}:
     sum{(p1,p2,p3) in P1P2P3} sigma[p1,p2,p3]*sum{q1 in Q1: rp1[p1,q1]==1, q2 in Q2: rp2[p2,q2]==1} U3[q1,q2,q3] - sum{h3 in H3} F3[h3,q3]*v3[h3] <= 0;
